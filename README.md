...
_See code: [src/commands/runtime/index.js](https://github.com/adobe/aio-cli-plugin-runtime/blob/8.0.0/src/commands/runtime/index.js)_
...
```
USAGE
  $ aio runtime api delete [BASEPATHORAPINAME] [RELPATH] [APIVERB] [--cert <value>] [--key <value>] [--apiversion
    <value>] [--apihost <value>] [-u <value>] [-i] [--debug <value>] [-v] [--version] [--help] [-r]
...
```
USAGE
  $ aio runtime api get [BASEPATHORAPINAME] [--cert <value>] [--key <value>] [--apiversion <value>] [--apihost
...
```
USAGE
  $ aio runtime rule delete [NAME] [--cert <value>] [--key <value>] [--apiversion <value>] [--apihost <value>] [-u
    <value>] [-i] [--debug <value>] [-v] [--version] [--help] [-r] [--json]
...
```
USAGE
  $ aio runtime rule disable [NAME] [--cert <value>] [--key <value>] [--apiversion <value>] [--apihost <value>] [-u
...
```
USAGE
  $ aio runtime rule enable [NAME] [--cert <value>] [--key <value>] [--apiversion <value>] [--apihost <value>] [-u
    <value>] [-i] [--debug <value>] [-v] [--version] [--help] [-r]
