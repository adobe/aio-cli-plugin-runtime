  ...
  describe('run', () => {
    ...
    test('tests for incorrect --param flags', (done) => {
      ...
      return command.run()
        ...
        .catch((err) => {
          expect(err).toMatchObject(new Error('failed to create the action: Please provide correct values for flags'))
          done()
        })
    })
    ...
    test('tests for incorrect --sequence flags', (done) => {
      ...
      return command.run()
        .then(() => done.fail('does not throw error'))
        .catch((err) => {
          expect(err).toMatchObject(new Error('failed to create the action: Provide a valid sequence component'))
          done()
        })
    })
    ...
    test('tests for incorrect action path', (done) => {
      ...
      return command.run()
        .then(() => done.fail('does not throw error'))
        .catch((err) => {
          expect(err).toMatchObject(new Error('failed to create the action: Provide a valid path for ACTION'))
          done()
        })
    })
    ...
    test('errors out on api error', (done) => {
      ...
      return command.run()
        .then(() => done.fail('does not throw error'))
        .catch((err) => {
          expect(err).toMatchObject(new Error('failed to create the action: an error'))
          done()
        })
    })
  })
