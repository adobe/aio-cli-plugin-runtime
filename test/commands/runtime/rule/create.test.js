...
const TheCommand = require('../../../../src/commands/runtime/rule/create.js')
const RuntimeBaseCommand = require('../../../../src/RuntimeBaseCommand.js')
const rtAction = 'rules.create'
...
test('args', async () => {
  ...
  expect(args.trigger.required).toBeTruthy()
  expect(args.trigger.description).toBeDefined()

  expect(args.action).toBeDefined()
  expect(args.action.required).toBeTruthy()
...
describe('instance methods', () => {
  ...
  describe('run', () => {
    ...
    test('errors out on api error', async () => {
      rtLib.mockRejected('rules.create', new Error('an error'))
      command.argv = ['nameFoo', 'triggerFoo', 'actionFoo']
      const error = ['failed to create rule', new Error('an error')]
